function Formulario() {
	return (
		<div className="md:w-1/2 lg:w-2/5">
			...
			<form className="bg-white shadow-md rounded-lg py-10 px-5 mt-3">
				<div className="mb-5">
				...
				<div className="mb-5">
					...
					<input id="email" type="text" placeholder="Nombre del Propietario" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" />
				</div>
				<div className="mb-5">
				...
				<div className="mb-5">
					...
					<textarea placeholder="Describe los Sintomas" id="sintomas" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"></textarea>
				</div>
